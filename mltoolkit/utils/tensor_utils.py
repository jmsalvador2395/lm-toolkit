...
def get_dl_params(seed: int):
    ...
    Output:
    - Callable: the seed worker function to pass to the dataloader 
      __init__ function
    - torch.Generator: the random number generator to pass to the 
      dataloader __init__ function
    """
